...
class Model:
    ...
    @modal.web_endpoint()
    def generate(self, request: Request, prompt: str = Query(..., description="The prompt for the image generation")):
...
def keep_warm():
    health_url = "https://rakinab--sd-demo-model-health.modal.run"
    generate_url = "https://rakinab--sd-demo-model-generate.modal.run"
    ...
    print(f"Generate endpont tested successfully at: {datetime.now(timezone.utc).isoformat()}")
